            ...
            <div className="max-w-6xl mx-auto space-y-8">
                <div className="text-center space-y-3">
                    <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl text-slate-100">
                        Passport Photo Compliance Engine
                    </h1>
                    <p className="text-slate-400 max-w-2xl mx-auto text-base">
                        Select your country to apply official biometric crop limits, head size ratios, and background requirements.
                    </p>
                </div>
                ...
                {filteredDocuments.length === 0 && (
                    <div className="text-center py-12 text-slate-500 text-sm">
                        No passport standard found matching "{searchQuery}".
                    </div>
                )}
            </div>
        </main>
