...
export const rrb_group_dConfig: FormatConfig = {
  id: 'rrb_group_d',
  title: 'RRB Group D 2025-2026',
  description: 'Official image formatting requirements for the Railway Recruitment Board Group D CEN 09/2025 application cycle.',
  category: 'exam',
  subCategory: 'Railway',
  documents: [
    {
      id: 'photo',
      name: 'Passport Photo',
      width: 413, // Calculated from 35mm at 300 DPI
      height: 531, // Calculated from 45mm at 300 DPI
      minKb: 30,
      maxKb: 70,
      rules: {
        minimumDpi: 100,
