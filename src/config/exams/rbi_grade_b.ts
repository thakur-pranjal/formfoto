...
export const rbi_grade_bConfig: FormatConfig = {
  id: 'rbi_grade_b',
  title: 'RBI Grade B 2026',
  description: 'Strict format and compliance specifications for uploading digital documents to the RBI Grade B 2026 banking recruitment portal.',
  category: 'exam',
  subCategory: 'Banking',
  documents: [
    {
    ...
    stampRequired: false,
      rules: {
        ...
        eyePositionRule: 'Eyes must be clearly seen. If using flash, ensure there is no "red-eye".',
        ...
        namingConvention: 'image01.jpg or image01.jpeg',
