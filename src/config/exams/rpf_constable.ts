...
export const rpf_constableConfig: FormatConfig = {
  id: 'rpf_constable',
  title: 'RPF Constable 2024',
  description: 'Official image formatting requirements for the Railway Protection Force Constable CEN RPF 02/2024 application.',
  category: 'exam',
  subCategory: 'Railway',
  documents: [
    {
      ...
      rules: {
        ...
        rejectionReasons: [
          'Uploading blurry, unclear, or low-resolution photographs or signatures.',
