...
export const ssc_stenographerConfig: FormatConfig = {
  ...
  description: 'Official digital document and live capture requirements for the Staff Selection Commission Stenographer Grade C & D (SSC Stenographer) 2026 application.',
  category: 'exam',
