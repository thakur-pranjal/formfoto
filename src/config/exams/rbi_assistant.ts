...
export const rbi_assistantConfig: FormatConfig = {
  id: 'rbi_assistant',
  title: 'RBI Assistant 2026',
  description: 'Strict format and compliance specifications for uploading digital documents to the RBI Assistant 2026 banking recruitment portal.',
  category: 'exam',
  subCategory: 'Banking',
  documents: [
    {
