...
export const ssc_mtsConfig: FormatConfig = {
  id: 'ssc_mts',
  title: 'SSC MTS 2026',
  description: 'Official digital document and live capture requirements for the Staff Selection Commission Multi-Tasking Staff (SSC MTS) 2026 application.',
  category: 'exam',
  ...
  documents: [
    ...
    },
    {
      id: 'signature',
      name: 'Signature',
      width: 709, // 6.0 cm converted to pixels at 300 DPI (6 / 2.54 * 300)
      ...
      rules: {
        ...
        widthAlternativeCm: 4.0, // Portal may alternatively prompt for 4.0 cm width
