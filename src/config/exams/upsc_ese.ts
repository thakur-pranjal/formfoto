...
export const upsc_eseConfig: FormatConfig = {
  id: 'upsc_ese',
  title: 'UPSC Engineering Services Examination (ESE) 2026',
  description: 'Official document formatting guidelines for the UPSC Engineering Services Examination (ESE) 2026, including mandatory live photograph and triple-signature upload rules.',
  category: 'exam',
    ...
    stampRequired: false,
      rules: {
        ...
        commonRejectionReasons: [
          ...
          'Out of frame and ear lobes not visible',
