...
export const upsc_cdsConfig: FormatConfig = {
  id: 'upsc_cds',
  title: 'UPSC Combined Defence Services (CDS) 2026',
  description: 'Complete 2026 UPSC CDS document upload requirements, featuring strict specifications for the new mandatory live photograph and triple-signature format.',
  category: 'exam',
  subCategory: 'Defence',
  documents: [
    {
