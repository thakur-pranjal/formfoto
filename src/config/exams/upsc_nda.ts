...
export const upsc_ndaConfig: FormatConfig = {
  id: 'upsc_nda',
  title: 'UPSC National Defence Academy (NDA) 2026',
  description: 'Official document upload specifications for the UPSC NDA 2026 examination, including mandatory live photo capture and vertical triple-signature requirements.',
  category: 'exam',
  subCategory: 'Defence',
  documents: [
    {
