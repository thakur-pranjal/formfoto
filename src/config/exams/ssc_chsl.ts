...
export const ssc_chslConfig: FormatConfig = {
  id: 'ssc_chsl',
  title: 'SSC CHSL',
  description: 'Official digital document and live capture requirements for the Staff Selection Commission Combined Higher Secondary Level (SSC CHSL) application.',
  category: 'exam',
  ...
  documents: [
    {
      ...
      rules: {
        ...
        stampRequired: false,
        changeFromPreviousYear: 'Candidates can no longer upload pre-scanned photograph files.',
        rejectionReasons: [
    ...
    },
    {
      id: 'signature',
      name: 'Signature',
      width: 472, // 4.0 cm at 300 DPI (4 / 2.54 * 300)
      height: 236, // 2.0 cm at 300 DPI (2 / 2.54 * 300)
      minKb: 10,
      maxKb: 20,
      rules: {
